...
class EmailForm(forms.Form):
    ...
    mailtype = forms.CharField(label='Mail envoyeur', widget=forms.Select(choices=MAIL_TYPE_CHOICES))
    ...
    label='Mail template',
    widget=forms.Select(attrs={'class': 'form-control form-control-lg template-dropdown mx-auto'}, choices=CONTENT_TEMPLATE),
    )
